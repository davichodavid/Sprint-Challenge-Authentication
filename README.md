...
To control the data accesible to api requests.

1. What does bcrypt do to help us store passwords in a secure manner.

Bcrypt hashes the passwords so they are not stored as text.

1. What does bcrypt do to slow down attackers?

It concats the pw with a random pw and re-hashes n' amount of times.

1. What are the three parts of the JSON Web Token?

They payload, the options and the secret.
